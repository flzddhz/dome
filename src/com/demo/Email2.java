    ...
    public static void main(String[] args) {
        ...
        String sql=
                " Select ou1.Name L_ORG, "+
                        ...
                        "		 p_org_id => ool.attribute15,p_date => TO_DATE('"+P_DATE_TO+" 23:59:59', 'YYYY-MM-DD HH24:MI:SS')) life_period " +
                        ...
                        "    And apps.cux_om_undone_ord_dtl_pkg.get_Org_Name(ool.attribute15) = '"+FACTORY+"' "+
                        "	 And hca.account_number in (" + CUST_NO + ")" +
                        ...
                        "                                                      TO_DATE('"+P_DATE_FROM+" 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), "+
                        "                                                      TO_DATE('"+P_DATE_TO+" 23:59:59', 'YYYY-MM-DD HH24:MI:SS')) = 'Y' "+
                        "    And Exists "+
                        "  (Select 1 "+
                        ...
                        "                NVL(TO_DATE('"+P_DATE_FROM+" 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), "+
                        "                    Sysdate) "+
                        "            And mmt.transaction_date <= "+
                        "                NVL(TO_DATE('"+P_DATE_TO+" 23:59:59', 'YYYY-MM-DD HH24:MI:SS'), "+
                        "                    Sysdate)) "+
                        " union "+
                        " Select ou1.Name L_ORG, "+
                        "        ou2.Name S_ORG, "+
